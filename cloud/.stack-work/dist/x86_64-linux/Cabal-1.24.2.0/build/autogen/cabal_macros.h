...
/* package fibo-0.1.0.0 */
#define VERSION_fibo "0.1.0.0"
#define MIN_VERSION_fibo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "fibo-0.1.0.0-AsDjIYThxQKLp780AFsA7"

#define CURRENT_PACKAGE_KEY "fibo-0.1.0.0-AsDjIYThxQKLp780AFsA7"
